...
const DEFAULT_SETTINGS = [
  {
    ...
    value: {
      ...
      email_reset_password: `${process.env.WEB_DOMAIN || "http://localhost:3000"}/reset-password`,
      email_confirmation_redirection: `${process.env.WEB_DOMAIN || "http://localhost:3000"}/email-confirmed`,
